...
async def channel_post(client: Client, message: Message):
    ...
    await reply_text.edit(f"JUDUL KONTEN\n\n🔗 <b>LINK VIDEO :</b>\n{link}\n\n✨ Mau request Video yang kalian inginkan disini @RequestVidBot", reply_markup=reply_markup, disable_web_page_preview = True)
